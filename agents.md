...
- NUNCA uses mockeos ni datos hardcodeados. Usa las variables de entorno definidas en `.env`.
- Si una variable de entorno no existe, créala en `.env` y en `.env.example`.
